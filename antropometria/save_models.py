...
from antropometria.preprocessing import deprecated_preprocess
...
def save_model(folder, dataset_name, classes, model, p_filter, reduction, sampling, min_max):
    data = deprecated_preprocess(folder, dataset_name, classes, p_filter, reduction, sampling, False, min_max)
